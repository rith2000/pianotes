    ...
    return (
      ...
      {({ containerWidth, containerHeight }) => (
        ...
        <div className="mt-5">
          ...
          <button className="btn" onHover = {styles} onClick={this.onClickStop}>Stop</button>{" "}
          ...
          <button className="btn" onClick={this.handleSharp}>Sharp</button>
          <button className="btn" onClick={this.handleFlat}>Flat</button>
